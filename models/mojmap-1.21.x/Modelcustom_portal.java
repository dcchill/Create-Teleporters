...
public class Modelcustom_portal<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "custom_portal"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition group = partdefinition.addOrReplaceChild("group", CubeListBuilder.create().texOffs(0, 171)
				.addBox(-43.0F, -91.0F, 2.0F, 85.0F, 85.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition base = partdefinition.addOrReplaceChild("base", CubeListBuilder.create().texOffs(0, 88)
				.addBox(0.0F, 0.0F, -17.0F, 48.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-24.0F, 8.0F, 9.0F));
		...
		PartDefinition hexadecagon_r1 = hexadecagon1.addOrReplaceChild("hexadecagon_r1", CubeListBuilder.create()
				...
				.texOffs(125, 56).addBox(-0.375F, 42.0F, -9.5478F, 5.75F, 6.0F, 19.0956F, new CubeDeformation(0.0F))
