...
public class Modelcustom_portal_ring<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("createteleporters", "modelcustom_portal_ring"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition group = partdefinition.addOrReplaceChild("group", CubeListBuilder.create().texOffs(0, 171).addBox(-42.5F, -42.5F, 0.0F, 85.0F, 85.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, -24.5F, 2.0F));
		...
		PartDefinition hexadecagon_r1 = hexadecagon1.addOrReplaceChild("hexadecagon_r1",
				CubeListBuilder.create().texOffs(45, 61).addBox(-0.375F, -48.0F, -9.5478F, 5.75F, 6.0F, 19.0956F, new CubeDeformation(0.0F)).texOffs(96, 50).addBox(-0.375F, 42.0F, -9.5478F, 5.75F, 6.0F, 19.0956F, new CubeDeformation(0.0F))
