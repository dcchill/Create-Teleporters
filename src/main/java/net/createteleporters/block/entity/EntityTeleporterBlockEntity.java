...
public class EntityTeleporterBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(1, ItemStack.EMPTY);

	public EntityTeleporterBlockEntity(BlockPos position, BlockState state) {
		super(CreateteleportersModBlockEntities.TELEPORTER.get(), position, state);
	}
